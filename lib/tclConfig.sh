...
TCL_EXTRA_CFLAGS='-g -O2 -pipe  -pipe '
...
# build directory.
TCL_BUILD_LIB_SPEC='-Wl,/usr/lib/libtcl8.5.dll.a'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-Wl,/usr/lib/libtclstub8.5.a'
...
TCL_BUILD_STUB_LIB_PATH='/usr/lib/libtclstub8.5.a'
