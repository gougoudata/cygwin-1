...
def svn_config_read(*args):
  """svn_config_read(char const * file, svn_boolean_t must_exist, apr_pool_t pool) -> svn_error_t"""
...
def svn_config_enumerate_sections2(*args):
  """svn_config_enumerate_sections2(svn_config_t * cfg, svn_config_section_enumerator2_t callback, void * baton, apr_pool_t pool) -> int"""
...
def svn_config_enumerate2(*args):
  """
    svn_config_enumerate2(svn_config_t * cfg, char const * section, svn_config_enumerator2_t callback, void * baton, 
        apr_pool_t pool) -> int
    """
...
def svn_dirent_internal_style(*args):
  """svn_dirent_internal_style(char const * dirent, apr_pool_t pool) -> char const *"""
  return _core.svn_dirent_internal_style(*args)

def svn_dirent_local_style(*args):
  """svn_dirent_local_style(char const * dirent, apr_pool_t pool) -> char const *"""
  return _core.svn_dirent_local_style(*args)

def svn_relpath__internal_style(*args):
  """svn_relpath__internal_style(char const * relpath, apr_pool_t pool) -> char const *"""
  return _core.svn_relpath__internal_style(*args)

def svn_dirent_join(*args):
  """svn_dirent_join(char const * base, char const * component, apr_pool_t pool) -> char *"""
  return _core.svn_dirent_join(*args)

def svn_relpath_join(*args):
  """svn_relpath_join(char const * base, char const * component, apr_pool_t pool) -> char *"""
  return _core.svn_relpath_join(*args)

def svn_dirent_basename(*args):
  """svn_dirent_basename(char const * dirent, apr_pool_t pool) -> char const *"""
  return _core.svn_dirent_basename(*args)

def svn_dirent_dirname(*args):
  """svn_dirent_dirname(char const * dirent, apr_pool_t pool) -> char *"""
  return _core.svn_dirent_dirname(*args)

def svn_dirent_split(*args):
  """svn_dirent_split(char const * dirent, apr_pool_t pool)"""
  return _core.svn_dirent_split(*args)

def svn_relpath_split(*args):
  """svn_relpath_split(char const * relpath, apr_pool_t pool)"""
  return _core.svn_relpath_split(*args)

def svn_relpath_basename(*args):
  """svn_relpath_basename(char const * relpath, apr_pool_t pool) -> char const *"""
  return _core.svn_relpath_basename(*args)

def svn_relpath_dirname(*args):
  """svn_relpath_dirname(char const * relpath, apr_pool_t pool) -> char *"""
  return _core.svn_relpath_dirname(*args)

def svn_uri_split(*args):
  """svn_uri_split(char const * uri, apr_pool_t pool)"""
  return _core.svn_uri_split(*args)

def svn_uri_basename(*args):
  """svn_uri_basename(char const * uri, apr_pool_t pool) -> char const *"""
  return _core.svn_uri_basename(*args)

def svn_uri_dirname(*args):
  """svn_uri_dirname(char const * uri, apr_pool_t pool) -> char *"""
...
def svn_dirent_canonicalize(*args):
  """svn_dirent_canonicalize(char const * dirent, apr_pool_t pool) -> char const *"""
  return _core.svn_dirent_canonicalize(*args)

def svn_relpath_canonicalize(*args):
  """svn_relpath_canonicalize(char const * relpath, apr_pool_t pool) -> char const *"""
  return _core.svn_relpath_canonicalize(*args)

def svn_uri_canonicalize(*args):
  """svn_uri_canonicalize(char const * uri, apr_pool_t pool) -> char const *"""
  return _core.svn_uri_canonicalize(*args)

def svn_dirent_is_canonical(*args):
  """svn_dirent_is_canonical(char const * dirent, apr_pool_t pool) -> svn_boolean_t"""
...
def svn_uri_is_canonical(*args):
  """svn_uri_is_canonical(char const * uri, apr_pool_t pool) -> svn_boolean_t"""
  return _core.svn_uri_is_canonical(*args)

def svn_dirent_get_longest_ancestor(*args):
  """svn_dirent_get_longest_ancestor(char const * dirent1, char const * dirent2, apr_pool_t pool) -> char *"""
  return _core.svn_dirent_get_longest_ancestor(*args)

def svn_relpath_get_longest_ancestor(*args):
  """svn_relpath_get_longest_ancestor(char const * relpath1, char const * relpath2, apr_pool_t pool) -> char *"""
  return _core.svn_relpath_get_longest_ancestor(*args)

def svn_uri_get_longest_ancestor(*args):
  """svn_uri_get_longest_ancestor(char const * uri1, char const * uri2, apr_pool_t pool) -> char *"""
  return _core.svn_uri_get_longest_ancestor(*args)

def svn_dirent_get_absolute(*args):
  """svn_dirent_get_absolute(char const * relative, apr_pool_t pool) -> svn_error_t"""
  return _core.svn_dirent_get_absolute(*args)

def svn_uri__is_child(*args):
  """svn_uri__is_child(char const * parent_uri, char const * child_uri, apr_pool_t pool) -> char const *"""
  return _core.svn_uri__is_child(*args)

def svn_dirent_is_child(*args):
  """svn_dirent_is_child(char const * parent_dirent, char const * child_dirent, apr_pool_t pool) -> char const *"""
  return _core.svn_dirent_is_child(*args)

def svn_relpath__is_child(*args):
  """svn_relpath__is_child(char const * parent_relpath, char const * child_relpath, apr_pool_t pool) -> char const *"""
...
def svn_relpath__is_ancestor(*args):
  """svn_relpath__is_ancestor(char const * parent_relpath, char const * child_relpath) -> svn_boolean_t"""
...
def svn_uri_get_dirent_from_file_url(*args):
  """svn_uri_get_dirent_from_file_url(char const * url, apr_pool_t pool) -> svn_error_t"""
  return _core.svn_uri_get_dirent_from_file_url(*args)

def svn_uri_get_file_url_from_dirent(*args):
  """svn_uri_get_file_url_from_dirent(char const * dirent, apr_pool_t pool) -> svn_error_t"""
...
def svn_swig_rangelist_merge(*args):
  """svn_swig_rangelist_merge(apr_array_header_t ** rangelist_inout, apr_array_header_t changes, apr_pool_t pool) -> svn_error_t"""
